...
!     "nbd"   is a dimension of the coefficient matrices nb*nd
    ...
    !   REAL, PARAMETER    :: tolcor   = -1.0
     ...
     &                        bflz(:,:,:,:,:)
      ...
      ALLOCATE(finc1(nn,nb,3,ns), fout1(nn,nb,3,ns), fint1(nn,nb,3,ns))
    ...
    !   ENDDO
      ...
      print *,"ubound", ubound(flxm)
      print *, "flxmdeb", flxm(1,1,1,1,1)
