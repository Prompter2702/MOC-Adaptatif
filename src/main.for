...
!     "nbd"   is a dimension of the coefficient matrices nb*nd
      ...
      INTEGER, PARAMETER :: ncelx = 2, ncely = 1, ncelz = 1
...
! Nombre de milieux
    ...
    !   print *,flxm(1,:,1,1)
     ...
     &                 " secondes"
      ...
      print *,"bflx", SUM(bflx(1,1,:,2,1,1,1,1), dim=1)/(ny*nz)
      print *,"bfly", SUM(bfly(1,1,:,2,1,1,1,1), dim=1)/(nx*nz)
      print *,"bflz", SUM(bflz(1,1,:,2,1,1,1,1), dim=1)/(nx*ny)
